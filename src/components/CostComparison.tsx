  ...
  return <section className="py-20 bg-gradient-to-br from-background to-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center bg-primary/5 rounded-2xl p-8 border border-primary/20">
          <h3 className="text-2xl font-bold text-foreground mb-4">Save $290,000+ Per Year</h3>
          <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
            Why spend 6x more building an in-house team when you can get better results, 
          ...
          <div className="text-3xl font-bold text-primary">
            That's an 83% cost reduction with 10x better results
          </div>
        </div>
      </div>
    </section>;
