...
const Pricing = () => {
  ...
  const addOns = ["Extra Reels: $333 per reel (additional to 16 included)", "Extra Avatars: $50/month per avatar (2 included in plan)"];
          ...
          <div className="mt-12 text-center animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-lime/10 rounded-lg p-6 border-2 border-lime/20">
                ...
                <div className="text-lg font-bold text-navy">$5,000/month</div>
