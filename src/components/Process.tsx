      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {steps.map((step, index) => <div key={index} className="flex flex-col lg:flex-row items-start lg:items-center gap-6 animate-scale-in" style={{
            animationDelay: `${index * 0.1}s`
                ...
                {index < steps.length - 1 && <div className="hidden lg:block flex-shrink-0">
