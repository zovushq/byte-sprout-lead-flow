          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="bg-white/10 rounded-lg p-6">
                <div className="text-4xl font-bold text-lime mb-2">$125</div>
                <div className="text-white/80">Average Cost Per Lead</div>
              </div>
              <div className="bg-white/10 rounded-lg p-6">
                <div className="text-4xl font-bold text-lime mb-2">2x</div>
                <div className="text-white/80">Client Acquisition vs Ads</div>
              </div>
              <div className="bg-white/10 rounded-lg p-6">
                <div className="text-4xl font-bold text-lime mb-2">90%</div>
                <div className="text-white/80">Client Retention Rate</div>
              </div>
              <div className="bg-white/10 rounded-lg p-6">
                <div className="text-4xl font-bold text-lime mb-2">7</div>
                <div className="text-white/80">Days to First Lead</div>
              </div>
            </div>
          </div>
        </div>
