...
// Pricing Rules
const REEL_PRICE = 333;
const AVATAR_PRICE = 50; // Per extra avatar
...
const PLAN_DESC = [
  ...
  "AI-Powered DM Automation included"
];
...
const CalculatorPage = () => {
  ...
  const reelsSubtotal = reelsCharged * REEL_PRICE;
          ...
          <div className="space-y-5 mb-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <Button
                  type="button"
                  onClick={() => setExtraAvatars(v => Math.max(0, v - 1))}
                  size="icon"
                  variant="secondary"
                  aria-label="decrease"
                >
